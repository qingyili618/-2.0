...
var script$2 = vue.defineComponent({
  ...
  setup(props) {
    ...
    vue.watch(() => rootProps.collapse, (value) => {
...
var Menu = vue.defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    return () => {
      ...
      const vnodeMenu = useVNodeResize(vue.h("ul", {
      ...
      if (props.collapseTransition && props.mode === "vertical") {
        return vue.h(script$3, () => vnodeMenu);
      }
      return vnodeMenu;
    };
  }
...
var script$1 = vue.defineComponent({
  ...
  setup(props, { emit, slots }) {
    const instance = vue.getCurrentInstance();
    const rootMenu = vue.inject("rootMenu");
    const { parentMenu, paddingStyle, indexPath } = useMenu(instance, vue.computed(() => props.index));
...
const ElSubMenu = withInstall.withNoopInstall(script$2);
